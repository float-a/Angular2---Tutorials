...
var HeroSearchComponent = (function () {
    ...
    //Push a search term into the observables stream
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            ...
            .distinctUntilChanged() //ignore is next search term is same as previous
            .switchMap(function (term) { return term ? _this._heroSearchService.search(term) : Observable_1.Observable.of([]); })
